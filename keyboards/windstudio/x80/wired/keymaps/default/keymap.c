...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______,   _______, _______, _______,  _______, _______, _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______,
    _______,   RGB_TOG, RGB_MOD, RGB_RMOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI,   RGB_VAD, _______, _______,          _______,
    _______,   _______, _______, _______,  _______, _______, _______, _______, MKC_MACOS, _______, _______, _______, _______, _______, _______, _______,
    _______,   MKC_LG,  _______, _______,                                                          _______, _______, _______, _______, _______, _______, _______
        ),
    [2] = LAYOUT(
    ...
    _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    _______, RGB_TOG, RGB_MOD, RGB_RMOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______,          _______,
    _______, _______, _______, _______,  _______, _______, _______, _______, MKC_WIN, _______, _______, _______, _______, _______, _______, _______,
